...
export const humidityChartWidgetSettingsSchema: WidgetSettingsSchema = {
  sections: [
    // General Settings
    {
      key: 'title',
      type: 'text',
      label: 'Widget Title',
      description: 'Display name for the humidity chart widget',
      defaultValue: 'Humidity Chart',
      maxLength: 50,
    },
      ...
      fields: [
        {
          ...
          type: 'select',
          label: 'Humidity Unit',
          description: 'Display humidity as percentage or decimal',
...
export default humidityChartWidgetSettingsSchema; 