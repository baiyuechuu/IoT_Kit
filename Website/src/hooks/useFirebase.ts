...
import { realtimeService, firebaseClient, type RealtimeSubscription, type VariableConfig, type FirebaseConfig } from '@/lib/firebase';
...
/**
 * Hook for Firebase connection and configuration
 */
export function useFirebaseConnection() {
  ...
  // Check initial state
  useEffect(() => {
    setConfigured(firebaseClient.isInitialized());
